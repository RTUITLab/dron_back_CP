...
func (tu *TaskUpdate) SetPractTestID(i int) *TaskUpdate {
	tu.mutation.SetPractTestID(i)
	return tu
}
...
func (tu *TaskUpdate) SetTestID(id int) *TaskUpdate {
	tu.mutation.SetTestID(id)
	return tu
}

// SetTest sets the "Test" edge to the PractTest entity.
func (tu *TaskUpdate) SetTest(p *PractTest) *TaskUpdate {
	return tu.SetTestID(p.ID)
}
...
func (tu *TaskUpdate) ClearTest() *TaskUpdate {
...
func (tu *TaskUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if tu.mutation.TestCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: true,
			Table:   task.TestTable,
			Columns: []string{task.TestColumn},
			Bidi:    false,
...
// SetPractTestID sets the "pract_test_id" field.
func (tuo *TaskUpdateOne) SetPractTestID(i int) *TaskUpdateOne {
	tuo.mutation.SetPractTestID(i)
	return tuo
}
...
// SetTestID sets the "Test" edge to the PractTest entity by ID.
func (tuo *TaskUpdateOne) SetTestID(id int) *TaskUpdateOne {
	tuo.mutation.SetTestID(id)
	return tuo
}

// SetTest sets the "Test" edge to the PractTest entity.
func (tuo *TaskUpdateOne) SetTest(p *PractTest) *TaskUpdateOne {
	return tuo.SetTestID(p.ID)
}
...
// ClearTest clears the "Test" edge to the PractTest entity.
func (tuo *TaskUpdateOne) ClearTest() *TaskUpdateOne {
