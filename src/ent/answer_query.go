...
// QueryQuestuion chains the current query on the "Questuion" edge.
func (aq *AnswerQuery) QueryQuestuion() *QuestionQuery {
...
func (aq *AnswerQuery) Clone() *AnswerQuery {
	...
	return &AnswerQuery{
		...
		withQuestuion: aq.withQuestuion.Clone(),
...
// WithQuestuion tells the query-builder to eager-load the nodes that are connected to
// the "Questuion" edge. The optional arguments are used to configure the query builder of the edge.
func (aq *AnswerQuery) WithQuestuion(opts ...func(*QuestionQuery)) *AnswerQuery {
	query := &QuestionQuery{config: aq.config}
	for _, opt := range opts {
		opt(query)
	}
	aq.withQuestuion = query
	return aq
}
...
func (aq *AnswerQuery) sqlAll(ctx context.Context) ([]*Answer, error) {
	...
	if query := aq.withQuestuion; query != nil {
