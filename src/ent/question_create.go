...
func (qc *QuestionCreate) SetTheoricalTestID(i int) *QuestionCreate {
	qc.mutation.SetTheoricalTestID(i)
	return qc
}
...
func (qc *QuestionCreate) SetTheoreticalTestID(id int) *QuestionCreate {
	qc.mutation.SetTheoreticalTestID(id)
	return qc
}

// SetTheoreticalTest sets the "TheoreticalTest" edge to the TheoreticalTest entity.
func (qc *QuestionCreate) SetTheoreticalTest(t *TheoreticalTest) *QuestionCreate {
	return qc.SetTheoreticalTestID(t.ID)
}
...
func (qc *QuestionCreate) check() error {
	if _, ok := qc.mutation.TheoricalTestID(); !ok {
		return &ValidationError{Name: "theorical_test_id", err: errors.New(`ent: missing required field "theorical_test_id"`)}
	}
	if _, ok := qc.mutation.Question(); !ok {
		return &ValidationError{Name: "question", err: errors.New(`ent: missing required field "question"`)}
	}
	if _, ok := qc.mutation.TheoreticalTestID(); !ok {
...
func (qc *QuestionCreate) createSpec() (*Question, *sqlgraph.CreateSpec) {
	...
	if nodes := qc.mutation.TheoreticalTestIDs(); len(nodes) > 0 {
